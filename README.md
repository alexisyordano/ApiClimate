...
este archivo debe llevar esta propiedades
...
luego ejecutamos Seeder : php artisan db:seed --class=RolesAndPermissionsSeeder, esto creara un usuario con rol Admin y permisos
